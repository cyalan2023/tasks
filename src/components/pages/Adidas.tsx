...
import Adidass from "../../assets/AdiFOM_TRXN_Shoes_Black_IG7453_01_standard.webp"
import Puma from "../../assets/Superstar_XLG_Shoes_Black_IG9777_01_standard.webp"
import Abibas
    ...
    return (
        <div>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
                {adidasArr.map((el) => (
                    <Link key={el.id} to={`/adidass/${el.id}`}>
                        <img src={el.picture}
                             alt={el.model}
